...
(function ($) {
  ...
  $container.append(
    '<h5 class="text-primary">Kustomisasi Dashboard</h5><hr class="mb-2"/>'
  )
  ...
  $container.append('<h6>Opsi Header</h6>')
  ...
  $container.append('<h6>Opsi Sidebar</h6>')
  ...
  $container.append('<h6>Opsi Footer</h6>')
  ...
  $container.append('<h6>Opsi Teks Kecil</h6>')
  ...
  $container.append('<h6>Varian Navbar</h6>')
